...
project = Project(
    ...
    project_html='''
        ...
        <h2>Glitch <span class="links"><a href="https://glitch.com/">Website</a> &middot; <a href="https://tracker.archiveteam.org/glitch/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/Glitch">Wiki</a></span></h2>
